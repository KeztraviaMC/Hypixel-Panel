        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body row">
                    <input type="hidden" name="database_limit" value="0"/>
                    <div class="col-md-6">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <style>#appendVariablesTo{display:flex;flex-wrap:wrap;align-items:flex-start}#appendVariablesTo .form-group{float:none}</style>
