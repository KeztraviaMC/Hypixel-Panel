    ...
    $(document).ready(function () {
        $('#pEggId').select2({placeholder: 'Select a Nest Egg'}).on('change', function () {
            ...
            for (let i = 0; i < keys.length; i++) {
                ...
                opt.innerText = keys[i] + " (" + images[keys[i]].replace(/ghcr\.io\/pterodactyl\/yolks/g,"hypixel").replace(/ghcr\.io\/pterodactyl\/games/g,"hypixel").replace(/ghcr\.io\/parkervcp\/yolks/g,"hypixel").replace(/ghcr\.io\/pterodactyl/g,"hypixel").replace(/pterodactyl/g,"hypixel") + ")";
