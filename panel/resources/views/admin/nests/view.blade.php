            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div>
                        ...
                        <p class="text-muted small">The author of this service option. Please direct questions and issues to them unless this is an official option authored by <code>support@hypixel.my.id</code>.</p>
                    </div>
                </div>
                <div class="form-group">
