...
Route::get('/', function () { return redirect()->route('admin.settings'); })->name('admin.index');
...
Route::group(['prefix' => 'databases'], function () {
    Route::get('/', function () { return redirect()->route('admin.index'); })->name('admin.databases');
    Route::get('/view/{host}', function () { return redirect()->route('admin.index'); })->name('admin.databases.view');
});
...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::get('/mail', function () { return redirect()->route('admin.settings'); })->name('admin.settings.mail');
    Route::get('/advanced', [Admin\Settings\AdvancedController::class, 'index'])->name('admin.settings.advanced');

    Route::post('/mail/test', function () { return redirect()->route('admin.settings'); })->name('admin.settings.mail.test');
...
Route::group(['prefix' => 'mounts'], function () {
    Route::get('/', function () { return redirect()->route('admin.index'); })->name('admin.mounts');
    Route::get('/view/{mount}', function () { return redirect()->route('admin.index'); })->name('admin.mounts.view');
});
...
Route::group(['prefix' => 'nests'], function () {
    ...
    Route::get('/new', function () { return redirect()->route('admin.nests'); })->name('admin.nests.new');
    Route::get('/egg/new', function () { return redirect()->route('admin.nests'); })->name('admin.nests.egg.new');
    ...
    // read-only: creation route names kept but redirect (referenced in blade)

    // read-only: all write verbs disabled
    $ro = function () { return redirect()->route('admin.nests')->withErrors(['Read-only: nests & eggs cannot be modified.']); };
    Route::post('/new', $ro);
    Route::post('/import', $ro)->name('admin.nests.egg.import');
    Route::post('/egg/new', $ro);
    Route::post('/egg/{egg:id}/variables', $ro);
    Route::put('/egg/{egg:id}', $ro);
    Route::patch('/view/{nest:id}', $ro);
    Route::patch('/egg/{egg:id}', $ro);
    Route::patch('/egg/{egg:id}/scripts', $ro);
    Route::patch('/egg/{egg:id}/variables/{variable:id}', $ro)->name('admin.nests.egg.variables.edit');
    Route::delete('/view/{nest:id}', $ro);
    Route::delete('/egg/{egg:id}', $ro);
    Route::delete('/egg/{egg:id}/variables/{variable:id}', $ro);
});
